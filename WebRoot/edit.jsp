            ...
            <s:form action="video/video_editVideo" cssClass="form-horizontal" enctype="multipart/form-data">
             ...
             <div class="form-group">
               ...
               <div class="form-group">
                ...
                <div class="col-md-2">
                   <input type="text" name="video.introduce" value="<s:property value='video.introduce'/>" class="form-control input-sm" required> 
                </div>
             </div>
              <div class="form-group">
                <label class="control-label col-md-3">类型</label>
                <div class="col-md-4">
                   <input type="text" name="video.videoType" value="<s:property value='video.vieoType'/>" class="form-control input-sm" required> 
                </div>
             </div>
              <div class="form-group">
             ...
             <a href="#" class="btn btn-danger fileupload-exists" data-dismiss="fileupload">取消</a>
              <div class="form-group">
                ...
                <div class="col-md-4">
                   <input type="text" name="video.path" value="<s:property value='video.path'/>" class="form-control input-sm" required> 
                </div>
             </div>
             </div>
             </div>
